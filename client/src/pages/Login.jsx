            ...
            <div className="neon-card relative overflow-hidden rounded-3xl border border-white/10 bg-obsidian-900/80 p-8 shadow-2xl backdrop-blur-2xl">
                ...
                <div className="relative z-10 text-center mb-8">
                    ...
                    <h2 className="font-display text-3xl font-extrabold text-white">
                        {showOTP ? 'Verify Access' : 'Welcome Back'}
                    </h2>
                    <p className="text-slate-400 text-xs font-mono mt-1.5">
                        {showOTP ? 'Enter the security PIN sent to your inbox' : 'Sign in to access your digital passes and telemetry'}
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="relative z-10 space-y-5">
                    ...
                    >
                        {loading 
                            ...
                            : (showOTP ? 'Verify & Authenticate ➔' : 'Initialize Session ➔')
                        }
                    </button>
                </form>
                ...
                <p className="relative z-10 text-center mt-8 font-mono text-xs text-slate-400">
                    ...
                    <Link to="/register" className="font-bold text-neon-cyan hover:text-white hover:underline transition-colors">
                        Sign up
                    </Link>
                </p>

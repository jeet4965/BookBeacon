...
exports.sendBookingOTP = async (req, res) => {
    try {
        ...
        console.error(`Unable to send booking OTP to ${req.user.email}:`, error.message);
        res.status(503).json({ error: 'We could not send the booking OTP. Please try again shortly.' });
    }
};
